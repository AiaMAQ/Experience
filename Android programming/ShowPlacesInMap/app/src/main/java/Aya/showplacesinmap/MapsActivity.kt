...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_MapType.setOnClickListener {
            if (mMap.mapType == GoogleMap.MAP_TYPE_NORMAL) {
                ...
                btn_MapType.text = "show"
            } else {
                mMap.mapType = GoogleMap.MAP_TYPE_NORMAL
                btn_MapType.text = "pass"
            }
        }
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val dynamo = LatLng(39.925533, 32.866287)
        mMap.addMarker(MarkerOptions().position(dynamo).title("TÜRKİYE"))
        mMap.moveCamera(CameraUpdateFactory.newLatLng(dynamo))
