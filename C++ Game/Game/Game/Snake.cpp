...
int main(int, int,const char*, int)
{
	SDL_Init(SDL_INIT_EVERYTHING);
	SDL_Window* window = SDL_CreateWindow("Snak", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 800, SDL_WINDOW_SHOWN);
	...
	uint32_t current_time=0, previous_time, delte_time;

	while (running)
	{
		previous_time = current_time;
		current_time = SDL_GetTicks();
		delte_time = current_time - previous_time;
